...
if(@$_POST["btn_create-product"]){
  ...
  try{
    ...
    $sql = "UPDATE product SET productName='$product_name',containerID='$container_id', cargoNumber='$cargo_number',cargoCompanyName='$cargo_company',departureCity='$DepartureCity', 
    arrivalCity='$ArrivalCity' WHERE productID='$product_id' ";
      $conn->exec($sql);
    	...
    	<figure class="logo animated fadeInDown delay-07s">
        	<a href="#"><img src="img/logo.png" alt=""></a>	
                    ...
                    <div class="form-group">
                            <input type="text" name="productid" class="form-control input-text" id="name" placeholder="Please enter product id for updating that product" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                        ...
                        <div class="text-center"><input type="submit"  name="btn_create-product" class="input-btn" value="Update Product"></div>
                    </form>
                </div>
